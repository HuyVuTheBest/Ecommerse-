...
<body>
	...
	<div class="nav-header" style="display: flex; justify-content: center; align-items: center; ">
		<div class="brand-title" >
				<h2 >Super Sneaker - Manager</h2>
				...
				<div class="collapse navbar-collapse justify-content-between">
					...
					<ul class="navbar-nav header-right">
						...
						<c:if test="${sessionScope.account !=null}">
							...
							<li class="nav-item d-flex align-items-center"> Xin chào  ${i.getRole()} ${i.getFullname()}</li>
						</c:if>
						...
						<li class="nav-item dropdown notification_dropdown"><a
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a href="../Register.jsp" class="dropdown-item ai-icon">
								...
								<c:if test="${sessionScope.account != null}">
									<a style="cursor: pointer;" onclick='logoutPopup()' class="dropdown-item ai-icon">
	...
	<div class="dlabnav">
		<div class="dlabnav-scroll">
			<ul class="metismenu" id="menu">
				...
				<li><a class="" href="StatisticManager" aria-expanded="false">
                            <i class="fas fa-home"></i>
                            <span class="nav-text">Quản lý thống kê</span>
                        </a>
                    </li>
                    <li><a  href="UserManager" aria-expanded="false">
                            <i class="fas fa-home"></i>
                            <span class="nav-text">Quản lý tài khoản</span>
                        </a>
                    </li>
                    <li><a  href="CategoryManager" aria-expanded="false">
                            <i class="fas fa-home"></i>
                            <span class="nav-text">Quản lý danh mục</span>
                        </a>
                    </li>
                    <li><a class="" href="ProductManager" aria-expanded="false">
                        <i class="fas fa-home"></i>
                        <span class="nav-text">Quản lý sản phẩm</span>
                    </a>
                </li>
                  
                    <li><a  href="OrderManager" aria-expanded="false">
                        <i class="fas fa-home"></i>
                    ...
                    <li><a class="" href="#" aria-expanded="false">
                        <i class="fas fa-home"></i>
                        <span class="nav-text">Quản lý tin tức, bài viết</span>
                    </a>
